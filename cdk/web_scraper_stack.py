...
class WebScraperStack(Stack):
    ...
    def create_second_hand_scrapers(self):
        ...
        sellpy_scraper_function = self.create_sellpy_scraper_function(chrome_driver_lambda_layer, article_topic.topic_arn, table_sellpy.table_name, html_bucket.bucket_name, email_queue.queue_url)
        vinted_scraper_function = self.create_vinted_scraper_function(chrome_driver_lambda_layer, article_topic.topic_arn, table_vinted.table_name, html_bucket.bucket_name, email_queue.queue_url)
        ...
        sender_email_identity, recipient_email_identity = self.create_email_identities(sender_email_param, recipient_email_param)        
    ...
    def create_cph_marathon_scraper(self):
        ...
        cph_marathon_scraper_function= self.create_cph_marathon_scraper_function(ticket_topic.topic_arn)
    ...
    def create_sellpy_table(self) -> TableV2:
        return TableV2(self, "ArticleTable",
            table_name='articles',
    ...
    def create_vinted_table(self) -> TableV2:
        return TableV2(self, "ArticleTableVinted",
    ...
    def create_sellpy_scraper_function(self, chrome_driver_layer, topic_arn, table_name, bucket_name, queue_url) -> PythonFunction:
    ...
    def create_vinted_scraper_function(self, chrome_driver_layer, topic_arn, table_name, bucket_name, queue_url) -> PythonFunction:
        return PythonFunction(
    ...
    def create_email_identities(self, sender_email_param, recipient_email_param) -> Tuple[ses.EmailIdentity, ses.EmailIdentity]:
    ...
    def create_article_topic(self) -> Topic:
        return Topic(self, "ArticleTopic",
            topic_name="article-topic"
        )

    def create_ticket_topic(self) -> Topic:
        return Topic(self, "TicketTopic",
